...
let typeMap: {[index: string]: any} = {
    ...
    "DeployContractParameter": DeployContractParameter,
    "DeployRequest": DeployRequest,
    "DeployResponse": DeployResponse,
    "MintRequest": MintRequest,
    "NftAccessRequest": NftAccessRequest,
    "NftClass": NftClass,
    "NftClassResponse": NftClassResponse,
    "NftDetail": NftDetail,
    "NftDetailResponse": NftDetailResponse,
    "NftGiveAccessRequest": NftGiveAccessRequest,
    "NftRentBurnRequest": NftRentBurnRequest,
    "NftRentDate": NftRentDate,
    "NftRentMintRequest": NftRentMintRequest,
    "NftRenterRequest": NftRenterRequest,
    "NftRenterResponse": NftRenterResponse,
    "NftSessionRequest": NftSessionRequest,
    "NftSessionResponse": NftSessionResponse,
    "TransferRequest": TransferRequest,
    "TransferResponse": TransferResponse,
    "UpdateChainSettle": UpdateChainSettle,
    "VerifyContractRequest": VerifyContractRequest,
    "VerifyContractResponse": VerifyContractResponse,
    "WalletGetRequest": WalletGetRequest,
    "WalletImportRequest": WalletImportRequest,
}
