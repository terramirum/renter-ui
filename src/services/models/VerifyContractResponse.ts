...
/**
* Cosmos based chain returns after two times call. Becuase chain processes the transaction. For solidity, take the flatten file from github and use etherscan to verify your contract.
*/
export class VerifyContractResponse {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return VerifyContractResponse.attributeTypeMap;
    }
